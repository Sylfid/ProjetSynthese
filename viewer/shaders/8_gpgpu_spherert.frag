...
float fresnelCoef2(in vec3 lightVector, in vec3 normal, in float etaU) {
    ...
    if(hasIntersect) {
        ...
        if(transparent == true){
            if(hasIntersect) {
                ...
                vec3 refractedRay2 = normalize(refract(refractedRay, vertNormal, eta));
                vec3 reflectedRay2 = normalize(reflect(refractedRay, vertNormal));
                float coeff2 = fresnelCoef(refractedRay, vertNormal, 1./eta);
                ...
                if(hasIntersect) {
                    ...
                    vec3 refractedRay3 = normalize(refract(refractedRay2, vertNormal, 1./eta));
                    vec3 reflectedRay3 = normalize(reflect(refractedRay2, vertNormal));
                    float coeff3 = fresnelCoef(refractedRay2, vertNormal, eta);
                    ...
                    if(hasIntersect) {
                        ...
                        vec3 refractedRay4 = normalize(refract(refractedRay3, vertNormal, eta));
                        vec3 reflectedRay4 = normalize(reflect(refractedRay3, vertNormal));
                        float coeff4 = fresnelCoef(refractedRay3, vertNormal, 1./eta);
