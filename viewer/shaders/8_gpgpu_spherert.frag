    ...
    if(hasIntersect) {
        ...
        if(hasIntersect) {
            ...
            if(hasIntersect) {
                ...
                vec3 refractedRay3 = refract(normalize(refractedRay2), vertNormal, 1./eta);
                vec3 reflectedRay3 = reflect(normalize(refractedRay2), vertNormal);
                ...
                if(hasIntersect) {
                    ...
                    vec3 refractedRay4 = refract(normalize(refractedRay3), vertNormal, eta);
                    vec3 reflectedRay4 = reflect(normalize(refractedRay3), vertNormal);
